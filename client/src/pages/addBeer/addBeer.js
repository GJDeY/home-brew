...
class CreateBeerForm extends Component {
    ...
    handleFormSubmit = (event) => {
        ...
        API.createBeer({
            beerName: this.state.beerName, brewer: this.state.brewer, beerNote: this.state.beerNote, style: this.state.style, imageURL: this.state.imageURL, hbcAddress: this.state.hbcAddress
        })
            .then(result => {
                console.log(result);
    ...
    render() {
        return (
            <div>
                ...
                <div style={{ color: 'white', margin: "40px 0px" }}>
                    <Form className="col-4 mx-auto">
                        ...
                        <FormGroup>
                            ...
                            <Input type="text" name="imageURL" value={this.state.imageURL} id="imageURLID" placeholder="Enter Vaild URL" onChange={this.handleInputChange} />
                        </FormGroup>
                        <FormGroup>
